...
var taskFormHandler =  function() {
  ...
  formEl.reset(); //Resets the placeholder content
...
var editTask = function(taskId) {
  ...
  //Change Add Task button to read Save Task
...
var deleteTask = function(taskId) {
  ...
  // create new array to hold updated list of tasks
    // Array element cannot be popped out, creating new list without the deleted task
  var updatedTaskArr = [];
